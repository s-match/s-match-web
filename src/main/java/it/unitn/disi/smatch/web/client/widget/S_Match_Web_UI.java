...
public class S_Match_Web_UI extends Composite implements ServerTaskOpener {
    ...
    MappingReporter_UI serverComUI;
    ...
    public S_Match_Web_UI() {
		 ...
		 * The main container
		 */
        DockLayoutPanel DockLayoutPanelTop = new DockLayoutPanel(Unit.EM);
        DockLayoutPanelTop.setHeight("800px");
        DockLayoutPanelTop.setWidth("100%");
        ...
        DockLayoutPanelTop.addNorth(sp_GenericOptions, 7.8);
        ...
        DockLayoutPanelTop.add(spl_CentralControl);

        initWidget(DockLayoutPanelTop);
		/*
