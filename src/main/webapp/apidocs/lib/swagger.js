...
(function() {
  var ApiKeyAuthorization, OAuthAuthorization, PasswordAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource,
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.buildFromSpec = function(response) {
      ...
      if (response.basePath) {
        if (response.basePath.indexOf("http") > 0) {
          this.basePath = response.basePath;
        } else {
          this.basePath = url.resolve(this.url, response.basePath);
        }
  ...
  OAuthAuthorization = (function() {
    OAuthAuthorization.prototype.type = null;

    OAuthAuthorization.prototype.consumerKey = null;

    OAuthAuthorization.prototype.consumerSecret = null;

    function OAuthAuthorization(type, consumerKey, consumerSecret) {
      this.type = type;
    ...
    OAuthAuthorization.prototype.apply = function(obj) {
      var accessor, authorizationHeader, message;
      accessor = {
      ...
      if (message.parameters && 0 < message.parameters.length && 0 < message.parameters[0].length) {
      ...
      return obj.headers["Authorization"] = authorizationHeader;
    };
